...
from .video_swap import VideoSwapper


class Face:
    def __init__(self, swap_model=None, age_model=None, gender_model=None,
                 face_model=None, emotion_model=None):
        """
        ...
        self._video_swapper = VideoSwapper(self._swapper)
    ...
    # ---- Swapping (video files, audio preserved) ----
    def swap_video(self, source_image, target_video, output_path, swap_every=1, show_progress=True):
        return self._video_swapper.swap_video(
            source_image, target_video, output_path,
            swap_every=swap_every, show_progress=show_progress,
        )
